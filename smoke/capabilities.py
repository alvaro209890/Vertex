...
CAPABILITY_CONTRACTS: tuple[CapabilityContract, ...] = (
    ...
    CapabilityContract(
        "provider_routing",
        "deepseek_provider_access",
        "zero_cost_provider_access",
        "providers.deepseek.DeepSeekProvider",
        "DeepSeek API key and Anthropic-compatible request",
        "streaming provider response",
        "missing credentials or upstream provider error",
    ...
    CapabilityContract(
        ...
        "DeepSeek provider selection per request",
        "skip live execution when DeepSeek is not configured",
        ("tests/api/test_model_router.py", "tests/config/test_config.py"),
        ("test_api_basic_conversation_e2e",),
    ),
    CapabilityContract(
    ...
    CapabilityContract(
        ...
        "Vertex CLI binary and proxy env",
